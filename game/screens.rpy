...
screen quick_menu():
    ...
    if quick_menu:
        ...
        hbox:
            ...
            textbutton _("Вперед") action RollForward()
...
screen menu2():
    ...
    imagemap:
        ...
        hotspot(985,35,430,75) action Call("AboutCompany")
        hotspot(985,145,430,75) action [Hide(main_menu),SetVariable("nkadr",3),Function(kadr)]#Call("RulesGame")
        hotspot(985,615,430,75) action Quit(confirm=True)
    ...
    #        text "ДЕЛОВАЯ ИГРА:\n«ФИНАНСОВЫЙ УЧЕТ ЦЕНТРА ВИРТУАЛЬНЫХ МИРОВ:\nОТ ОПЕРАЦИЙ К ОТЧЕТНОСТИ»":
...
screen about():
    ...
    use game_menu(_("Об игре"), scroll="viewport"):
        ...
        vbox:
            ...
            label "ДЕЛОВАЯ ИГРА: «ФИНАНСОВЫЙ УЧЕТ ЦЕНТРА ВИРТУАЛЬНЫХ МИРОВ: ОТ ОПЕРАЦИЙ К ОТЧЕТНОСТИ»\n\n\n"
            ...
            text _("Деловая игра предназначена для изучения основных операций и отчетности в финансовом учета на примере Центра виртуальных миров.")
